...
<html>
    ...
    <?php
        ...
        if(empty($_REQUEST["requested_student_name"]))
        {
            $_SESSION["sname"] = "";
        }
        ...
        {
            $_SESSION["sname"] = $_REQUEST["requested_student_name"];
        }
        
        if(empty($_REQUEST["requested_student_gender"]))
        {
            $_SESSION["gender"] = "";
        }
        ...
        {
            $_SESSION["gender"] = $_REQUEST["requested_student_gender"];
        }
        
        if(empty($_REQUEST["requested_student_phone"]))
        {
            $_SESSION["phone"] = "";
        }
        ...
        {
            $_SESSION["phone"] = $_REQUEST["requested_student_phone"];
        }
        
        if(empty($_REQUEST["requested_student_birth"]))
        {
            $_SESSION["birth"] = "";
        }
        ...
        {
            $_SESSION["birth"] = $_REQUEST["requested_student_birth"];
        }
        
        if(empty($_REQUEST["requested_student_email"]))
        {
            $_SESSION["email"] = "";
        }
        ...
        {
            $_SESSION["email"] = $_REQUEST["requested_student_email"];
        }
    ?>
            ...
            <form method="get" action="">
                <div class="borrow_box" style="padding-bottom: 15px;">
                    <h3 style="font-size: 20px; padding-left: 10px; color: orange;">
                        ...
                        <span style="color: red; font-size: 15px;"> *The informations of empty block would not be changed.</span>
                    </h3>
                    <div class="search-form" style="margin-left: 70px; ">
                        <div class="group">
                            ...
                            <input type="text" class="input" name="requested_student_gender" placeholder="male/female" style="margin-right: 40px; width: 250px;">
                            <br>

                            <label class="label" style="margin-right: 9px;"> Phone number </label>
                            <input type="text" class="input" name="requested_student_phone" placeholder="000-00-0000" style="margin-right: 53px; width: 250px; margin-bottom: 15px;">
                            <label class="label" style="margin-right: 28px;"> Birth </label>
                            <input type="date" class="input" name="requested_student_birth" placeholder="YYYY-MM-DD" style="margin-right: 40px; width: 250px;">
                            <br>

                            <label class="label" style="margin-right: 72px;"> Email </label>
                            <input type="text" class="input" name="requested_student_email" style="margin-right: 415px; width: 250px;">
                            
                            <input type="submit" class="button" value="Set Information" action="">
                        </div>
                    </div>
                </div>
            </form>
                ...
                <table width="1040" border="1" cellspacing="0" cellpadding="8" style="margin: 0 auto; margin-top: 12px;">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <form method="post" action="modify_student_back.php">
                                <input type="hidden" name="student_id" value=<?=htmlspecialchars($row['sid'])?>>
                                <input type="hidden" name="student_name" value=<?=htmlspecialchars($row['name'])?>>
                                <input type="hidden" name="student_gender" value=<?=htmlspecialchars($row['gender'])?>>
                                <input type="hidden" name="student_birth" value=<?=htmlspecialchars($row['birth'])?>>
                                <input type="hidden" name="student_email" value=<?=htmlspecialchars($row['email'])?>>
                                <input type="hidden" name="student_phone" value=<?=htmlspecialchars($row['phone'])?>>
                                <td align="center" style="word-break: break-all;"> <input type="submit" class="button" value="Modify" action=""> </td>
                            </form>
                        </tr>
                        <?php
                        }
