    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="borrow_box" style="padding-bottom: 15px;">
                ...
                <form method="post" action="add_book_back.php">
                    <div class="search-form" style="margin-left: 70px; ">
                        <div class="group">
                            <label class="label" style="margin-right: 72px; margin-bottom: 10px;"> Title </label>
                            <input type="text" class="input" name="requested_title" style="margin-right: 50px; width: 250px; margin-bottom: 15px;">
                            
                            <label class="label" style="margin-right: 9px;"> Publisher </label>
                            <input type="text" class="input" name="requested_publisher" style="margin-right: 40px; width: 250px;">
                            <br>
                            
                            <label class="label" style="margin-right: 55px;"> Author </label>
                            <input type="text" class="input" name="requested_author" style="margin-right: 515px; width: 250px; margin-bottom: 15px;">
                            
                            <input type="submit" class="button" value="Add" action="/add_book_back.php">
                        </div>
                    </div>
                </form>
            </div>
