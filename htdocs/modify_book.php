        ...
        <div class="container">
            ...
            <form method="get" action="">
                <div class="borrow_box" style="padding-bottom: 15px;">
                    ...
                    <div class="search-form" style="margin-left: 70px; ">
                        <div class="group">
                            <label class="label" style="margin-right: 10px; margin-bottom: 10px;"> Book title </label>
                            <input type="text" class="input" name="requested_title" style="margin-right: 40px; width: 400px; margin-bottom: 15px;">
                            
                            <br>
                            <label class="label" style="margin-right: 9px;"> Publisher </label>
                            <input type="text" class="input" name="requested_publisher" style="margin-right: 85px; width: 250px;">

                            <label class="label" style="margin-right: 9px;"> Author </label>
                            <input type="text" class="input" name="requested_author" style="margin-right: 53px; width: 250px; margin-bottom: 15px;">
                ...
                <table width="1040" border="1" cellspacing="0" cellpadding="8" style="margin: 0 auto;">
                    <tbody>
                        ...
                        <tr>
                            ...
                            ?>
                            <form method="post" action="modify_book_back.php">
                                <input type="hidden" name="cur_book_id" value=<?=htmlspecialchars($row['bid'])?>>
                                <input type="hidden" name="cur_title" value=<?=htmlspecialchars($row['title'])?>>
                                <input type="hidden" name="cur_author" value=<?=htmlspecialchars($row['author'])?>>
                                <input type="hidden" name="cur_publisher" value=<?=htmlspecialchars($row['publisher'])?>>
                                <input type="hidden" name="cur_returned" value=<?=htmlspecialchars($row['returned'])?>>
